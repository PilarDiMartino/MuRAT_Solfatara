...
zlabel('Depth (m)','FontSize',16,'FontWeight','bold','Color','k')

xym=linspace(0,160,11);
xticks(y); xticklabels([xym]);
%set(gca,'xticklabel',num2str(get(gca,'xtick')','%.2f'))
yticks(x); yticklabels([xym])
%set(gca,'yticklabel',num2str(get(gca,'ytick')','%.2f'))
zm=linspace(70,100,7);
zticks(z); zticklabels([zm])
